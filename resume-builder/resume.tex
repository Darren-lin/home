...
\sectiontable{SKILLS \& AWARDS}{
    \entry{Languages}{Ruby on Rails, Scala/Chisel, Python, C/C++, HTML/CSS, JavaScript, Verilog, Java}
    \entry{Miscellaneous}{Git, Linux, React, TypeScript, Vue, AWS Amplify, Firebase, GraphQL, S3, DynamoDB, Heroku, sbt}
